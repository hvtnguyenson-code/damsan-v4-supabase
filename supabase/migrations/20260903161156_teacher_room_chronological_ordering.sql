-- Migration: 20260903080001_teacher_room_chronological_ordering.sql
-- Description: Expose created_at metadata and enforce deterministic tie-breaker in rpc_lay_danh_sach_phong_thi_gv
...
begin
  ...
  ) order by pt.created_at desc, pt.id desc), '[]'::jsonb) into v_rooms
