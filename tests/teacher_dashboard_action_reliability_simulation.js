...
async function runAllTests() {
  ...
  // 25. Teacher exact: 20260903-flex-lite-006
  console.log('Test DASH-ACT-25: Teacher cache bust is exact 20260903-flex-lite-006');
  {
    assert(gvHtmlSource.includes('giaovien.js?v=20260903-flex-lite-006'),
      'giaovien.html must include giaovien.js?v=20260903-flex-lite-006');
