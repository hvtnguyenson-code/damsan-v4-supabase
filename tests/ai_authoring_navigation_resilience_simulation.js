...
must(knowledge, /File gốc luôn được giữ làm nguồn đối chiếu[\s\S]*Nguồn đạt kiểm định sẽ được dùng cho AI ra đề/i, 'A031C-08 raw provenance and validated-source gate are visible before exam authoring');
