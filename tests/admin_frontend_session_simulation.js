...
// F127: giaovien.html accepts .xlsx only and has cache bust 20260903-flex-lite-008
...
assert(htmlSource.includes('giaovien.js?v=20260903-flex-lite-008'), 'F127 cache bust query updated to 20260903-flex-lite-008');
recordB3('F127');
