...
// F127: giaovien.html accepts .xlsx only and has cache bust 20260902-flex-lite-004
...
assert(htmlSource.includes('giaovien.js?v=20260902-flex-lite-004'), 'F127 cache bust query updated');
recordB3('F127');
