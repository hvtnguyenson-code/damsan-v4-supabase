...
{
    const teacherVersion = '20260902-flex-lite-004';
    const studentVersion = '20260902-flex-lite-005';
    assert(gvHtmlSource.includes(`giaovien.js?v=${teacherVersion}`), 'SCORE-UI-15: giaovien.html must include giaovien.js?v=20260902-flex-lite-004');
